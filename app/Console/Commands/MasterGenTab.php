...
class MasterGenTab extends Command
{
...
php artisan gentab {primary_table} {secondary_tables*} {folder}


php artisan gentab class_subject class secondary_tables=classes secondary_tables=subjects
php artisan gentab parent_student parent secondary_tables=parents secondary_tables=students
php artisan gentab paper_subject subject secondary_tables=subjects secondary_tables=papers

php artisan gentab student_subject student secondary_tables=students secondary_tables=subjects
php artisan gentab combination_student student secondary_tables=students secondary_tables=combinations
php artisan gentab class_stream class secondary_tables=classes secondary_tables=streams
php artisan gentab assessment_student student secondary_tables=students secondary_tables=assessments
php artisan gentab assessment_class assessment secondary_tables=assessments secondary_tables=classes
php artisan gentab assessment_subject assessment secondary_tables=assessments secondary_tables=subjects


cd /var/www/erengplay && php artisan gentab admission_encounter secondary_tables=admissions secondary_tables=encounters && cd /var/www/billing && git checkout routes/api.php && git diff

these are actually prescriptions ... only payment to accounts deteremines pharmacy

cd /var/www/erengplay && php artisan gentab mysqlhis Encounter medications secondary_tables=encounters secondary_tables=conditions && cp /var/www/erengplay/storage/logs/tab.vue /var/www/his_frontend/src/components/patient/medication.vue && subl /var/www/his_frontend/src/components/patient/medication.vue
*/
   ...
   * @var string
   */
  protected $signature = 'gentab {connection} {parent_model} {primary_table} {secondary_tables*}';
...
// dd('callinmg view tab');
        \App\Console\Commands\MVC\ViewTab::get(
          $connection,
          $fieldsFrontEnd,
          $modelFrontEnd,
          $importModelFrontEnd,
